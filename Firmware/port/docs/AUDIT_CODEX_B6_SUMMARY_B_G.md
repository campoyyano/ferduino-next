# Resumen de auditoría — Documentación NVM/EEPROM (Secciones B..G)

> Este documento es un extracto consolidado (B a G, ambos incluidos) para guardarlo en la repo.
...
Estado real: solo hay 3 keys concretas definidas/insertadas en el port (en el momento de la auditoría).
...
| `840` | `byte` sentinel | `salvar_outlets_EEPROM` / `Setup.h` | Marca bloque outlets válido | `310 outlet.block_valid` (bool) | Migrado ya |
| `841..849` | `9 x byte` | `salvar_outlets_EEPROM` / `ler_outlets_EEPROM` | Estado outlets 1..9 | `311..319 outlet.N.state` | Migrado ya |
| `706` | `byte` sentinel | `Salvar_dosadora_EEPROM` / `ler_dosadora_EEPROM` | Marca bloque dosificación válido | `500 dosing.block_valid` | Migrado ya |
| `545` | `array struct` (`dosaconfig[6]`) | `Salvar_dosadora_EEPROM` / `ler_dosadora_EEPROM` | Dosis personalizada por canal (`x10`) | `510..515 dosing.chN.dose_x10` | Migrado ya |
| `557..562` | `6 x byte` | `Salvar_dosadora_EEPROM` | Hora inicio dosificación canal | `520..525 dosing.chN.start_hour` | Migrado ya |
| `583..588` | `6 x byte` | `Salvar_dosadora_EEPROM` | Minuto inicio dosificación canal | `530..535 dosing.chN.start_min` | Migrado ya |
| `589..625` | `7 x 6 bytes` | `Salvar_dosadora_EEPROM` | Días activos dosificación canal | `540..545 + mask` (bitmask sugerido) | Migrado ya |
| `631..636` | `6 x byte` | `Salvar_dosadora_EEPROM` | Cantidad dosis por canal | `550..555 dosing.chN.quantity` | Migrado ya |
| `637..642` | `6 x byte` | `Salvar_dosadora_EEPROM` | Modo on/off dosificación canal | `560..565 dosing.chN.enabled` | Migrado ya |
| `643..648` | `6 x byte` | `Salvar_dosadora_EEPROM` | Hora fin dosificación canal | `570..575 dosing.chN.end_hour` | Migrado ya |
| `649..654` | `6 x byte` | `Salvar_dosadora_EEPROM` | Minuto fin dosificación canal | `580..585 dosing.chN.end_min` | Migrado ya |
...
| `840` | outlets sentinel | `310 outlet.block_valid` | Migrado ya |
| `841..849` | outlets[1..9] | `311..319 outlet.N.state` | Migrado ya |
| `545` | dosaconfig[6].dose_personalizada | `510..515 dosing.chN.dose_x10` | Migrado ya |
| `557..562` | dosing start hour | `520..525 dosing.chN.start_hour` | Migrado ya |
| `583..588` | dosing start minute | `530..535 dosing.chN.start_min` | Migrado ya |
| `637..642` | dosing enable | `560..565 dosing.chN.enabled` | Migrado ya |
| `643..648` | dosing end hour | `570..575 dosing.chN.end_hour` | Migrado ya |
| `649..654` | dosing end minute | `580..585 dosing.chN.end_min` | Migrado ya |
